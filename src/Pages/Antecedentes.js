         ...
         <form action="">
            <div className="formAntecedentes">
                     ...
                     arrayRadioButton={
                        {
                           nameButton: "Rural",
                           array: [
                              { id: "Radio1jardin", title: "Rural", valueBotton: "Rural" },
                              { id: "Radio2jardin", title: "Urbano", valueBotton: "Urbano" }
                           ]
                        }}
               ...
               <div>
                  ...
                  <InputText type="date" arrayInput={{ id: "fechaNacimiento", title: "Fecha de nacimiento" }} handle={getEdad} />
               ...
               <div>
                  ...
                  <InputText type="text" arrayInput={{ id: "barrio", title: "Barrio" }} handle={hnadleInputText} />
                  <InputText type="text" arrayInput={{ id: "ciudad", title: "Ciudad/Municipio" }} handle={hnadleInputText} />
                  <InputText
                     type="radio"
                     arrayRadioButton={
                        {
                           nameButton: "Rural2",
                           array: [
                              { id: "Radio1paciente", title: "Rural", valueBotton: "Rural" },
                              { id: "Radio2paciente", title: "Urbano", valueBotton: "Urbano" }
                           ]
                        }}
                     handle={hnadleInputText}
                  />
